...
const ProductCard = ({ product, imgSize = "w-[150px] h-[150px]" }) => (
...
const Cards = () => {
  ...
  return (
    <div className="bg-white px-36 ">
        ...
        <Typography style="text-center flex justify-center mx-auto  py-10 font-semibold " varient="h3">
      ...
      <div className="flex  gap-6  ">
        ...
        {featured && (
          <div className="bg-[#F8F8F8] p-4 relative w-[700px] flex flex-col">
            <Typography
              varient="h4"
              style="text-[#2196F3] font-semibold"
        ...
        <div className="flex flex-col gap-6 flex-1  ">
          <div className="grid grid-cols-2 gap-6">
            {top1 && (
              <ProductCard product={top1} imgSize="w-[180px] h-[180px]" />
            )}
            {top2 && (
              <ProductCard product={top2} imgSize="w-[180px] h-[180px]" />
            )}
          </div>
